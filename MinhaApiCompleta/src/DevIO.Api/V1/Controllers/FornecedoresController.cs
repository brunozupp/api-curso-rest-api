...
{
    // Dentro do aspnetCore, o apiVersion já faz parte do contexto da controller rodando
    // então ele já entende que precisa substituir essa valor atráves da config de versionamento que eu tenho
    [Authorize]
    [ApiVersion("1.0")]
    ...
    public class FornecedoresController : MainController
    {
        ...
        public async Task<ActionResult<IEnumerable<FornecedorViewModel>>> ObterTodos()
        {
            ...
            var viewModel = _mapper.Map<IEnumerable<FornecedorViewModel>>(fornecedor);
