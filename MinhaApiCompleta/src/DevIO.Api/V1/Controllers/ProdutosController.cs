...
namespace DevIO.Api.V1.Controllers
{
    ...
    public class ProdutosController : MainController
    {
        ...
        [HttpPost("adicionar_alternativo")]
        ...
        //[DisableRequestSizeLimit] // Desabilita o tamanho de recebimento de um arquivo
        [RequestSizeLimit(40000000)] // Limitar em 40MB
        [HttpPost("imagem")]
        ...
        private async Task<bool> UploadArquivoAlternativo(IFormFile arquivo, string imagemPrefixo)
        {
